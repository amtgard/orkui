    ...
    <div class="col-md-3 col-lg-2 list-group userList">
      ...
      <div class="list-group-item">
        ...
        <div class="pull-right">
          <button v-if="activePlayers.length > 0" @click="togglePlayers" class="btn btn-default btn-xs" title="Toggle Players">
            <span class="glyphicon" :class="(showPlayers) ? 'glyphicon-chevron-up' : 'glyphicon-chevron-down'"></span>
          </button>
        </div>
...
export default {
  ...
  computed: {
    ...
    kingdom () {
      let kingdom = Collection.find(this.$store.getters.getKingdoms, {KingdomId: this.park.KingdomId})
